...
async function launchRandomTrailer() {
    const button = document.getElementById("rightNowTrailerBtn");
    ...
    try {
        ...
        button.textContent = "🎲 Vibe right now";
    }
}

const rightNowTrailerBtnEle = document.getElementById("rightNowTrailerBtn");

if (rightNowTrailerBtnEle) {
    rightNowTrailerBtnEle.addEventListener("click", launchRandomTrailer);
}
